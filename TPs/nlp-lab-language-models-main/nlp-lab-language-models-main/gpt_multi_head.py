...
class Head(nn.Module):
    ...
    def __init__(self, head_size):
        ...
        # Définir les couches Key, Query, et Value comme des couches linéaires
...
class BigramLanguageModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.att=nn.Sequential(*[Block(n_embd, n_heads) for _ in range(3)])
...
context = torch.ones((1,8), dtype=torch.long, device=device)*prompt
